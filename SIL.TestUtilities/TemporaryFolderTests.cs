...
namespace SIL.TestUtilities {
	...
	public class TemporaryFolderTests
	{
		...
		{
			var temporaryFolder = new TemporaryFolder("Constructor_CreatesTemporarySubDirectory");
		...
		{
			TemporaryFolder temporaryFolder = new TemporaryFolder("GetTemporaryFile_FileExistsInTemporarySubdirectory");
...
#pragma warning restore 618
		...
		{
			TemporaryFolder temporaryFolder = new TemporaryFolder("GetTemporaryFile_Name_FileWithNameExistsInTemporarySubdirectory");
#pragma warning disable 618
...
#pragma warning restore 618
		...
		{
			TemporaryFolder temporaryFolder = new TemporaryFolder("GetTemporaryFile_CalledTwice_BothFilesFoundInSameTemporarySubdirectory");
#pragma warning disable 618
