...
namespace SIL.Windows.Forms.Reporting
{
	public class WinFormsExceptionHandler: ExceptionHandler
	{
		...
		/// </summary>
		/// <param name="ignoreExceptions">if true, does not listen for exceptions</param>
		/// ------------------------------------------------------------------------------------
		public WinFormsExceptionHandler(bool ignoreExceptions = false)
		{
			...
			// Setting ignoreExceptions to true assumes that the application will use another
