...
namespace SIL.Windows.Forms.Miscellaneous
{
	public partial class SILAboutBox : Form
	{
		...
		private string GetWindowTitle()
		{
			...
			return string.Format(LocalizationManager.GetString("AboutDialog.WindowTitle", "About {0}"), GetApplicationTitle());
		}
		...
		private string GetBuiltOnDate()
		{
			...
			// of timezone setting.
			return string.Format(LocalizationManager.GetString("AboutDialog.BuiltOnDate", "Built on {0}"), fi.CreationTimeUtc.ToString("dd-MMM-yyyy"));
		}
