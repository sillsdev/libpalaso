...
#region Paint Methods
		...
		private void paint_Text(PaintEventArgs e)
		{
			...
			if(State == BtnState.Inactive)
			{
				...
				{
					if (TextWordWrap && !TextDropShadow)
						TextRenderer.DrawText(e.Graphics, this.Text, this.Font, new Rectangle(pt.X+1, pt.Y+1, size.Width, size.Height), DisabledTextColor);
					else
			...
			else
			{
				...
				{
					if (TextWordWrap && !TextDropShadow)
						TextRenderer.DrawText(e.Graphics, this.Text, this.Font, new Rectangle(pt.X+1, pt.Y+1, size.Width, size.Height), this.ForeColor);
					else
...
#region Helper Methods
		...
		private System.Drawing.Size CalculateBestWrappingSize(Graphics g)
		{
			...
			if (UseCompatibleTextRendering)
				...
				return TextRenderer.MeasureText(g, this.Text, this.Font, new Size(this.Width, Int32.MaxValue));
		}
