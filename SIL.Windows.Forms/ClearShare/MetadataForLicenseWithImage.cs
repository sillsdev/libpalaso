...
namespace SIL.Windows.Forms.ClearShare
{
	...
	/// </summary>
	public class MetadataForLicenseWithImage : Metadata
	{
		public new static MetadataForLicenseWithImage FromFile(string path)
		{
			var m = new MetadataForLicenseWithImage() { _path = path };
			LoadProperties(path, m);
			return m;
		}

		public new MetadataForLicenseWithImage DeepCopy()
		{
			return (MetadataForLicenseWithImage)CloneObject(this);
		}
		...
		private static void LoadProperties(string path, MetadataForLicenseWithImage destinationMetadata)
		{
			try
			{
		...
		/// </remarks>
		internal static void LoadProperties(ImageTag tagMain, MetadataForLicenseWithImage destinationMetadata)
		{
