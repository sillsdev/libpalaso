...
namespace SIL.Windows.Forms.ClearShare.WinFormsUI
{
	partial class MetadataEditorControl
	{
		...
		private void InitializeComponent()
		{
			...
			this._licenseImage.Location = new System.Drawing.Point(67, 363);
			...
			this._unknownLicense.Location = new System.Drawing.Point(53, 448);
			...
			this._customLicense.Location = new System.Drawing.Point(53, 483);
			...
			this._customRightsStatement.Location = new System.Drawing.Point(74, 530);
			...
			this._useIGOLicenseVersion.Location = new System.Drawing.Point(74, 338);
			...
			this._L10NSharpExtender.SetLocalizationComment(this._linkToPublicDomainCC0, "CC0 should not be translated.  The link takes you to a place that defines \"Creati" +
        "ve Commons 0\".");
			this._L10NSharpExtender.SetLocalizingId(this._linkToPublicDomainCC0, "MetadataEditor.LinkToCC0");
			...
			this._linkToPublicDomainCC0.Text = "about CC0 Public Domain";
			this._linkToPublicDomainCC0.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this._linkToPublicDomainCC0.URL = "https://creativecommons.org/share-your-work/public-domain/cc0/";
			// 
        ...
        " the bottom.");
			...
			this._additionalRequestsLabel.Location = new System.Drawing.Point(53, 512);
			...
			this._linkToRefinedCreativeCommonsWarning.Location = new System.Drawing.Point(226, 508);
