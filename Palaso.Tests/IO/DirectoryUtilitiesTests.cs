...
namespace Palaso.Tests.IO
{
	...
	public class DirectoryUtilitiesTests
	{
		...
		{
#if MONO
			// 02 SEP 2013, Phil Hopper: this test is not valid on a linux file system, just return
			return;
#else
		...
		public void AreDirectoriesEquivalent_DifferByTrailingCurrentDirectoryDot_ReturnsTrue()
		{
			// 02 SEP 2013, Phil Hopper: set correct directory separator for OS
			//Assert.IsTrue(DirectoryUtilities.AreDirectoriesEquivalent(@"C:\temp", @"C:\temp\."));
			Assert.IsTrue(DirectoryUtilities.AreDirectoriesEquivalent("C:" + _directorySeparator + "temp", "C:" + _directorySeparator + "temp" + _directorySeparator + "."));
		}
...
DirectoryUtilities.AreDirectoriesEquivalent(@"C:\temp...\", @"C:\temp"));
		...
		public void AreDirectoriesEquivalent_OnePathContainsBacktrackingToParentFolders_ReturnsTrue()
		{
			...
			Assert.IsTrue(DirectoryUtilities.AreDirectoriesEquivalent("C:" + _directorySeparator + "temp", "C:" + _directorySeparator + "temp" + _directorySeparator + "x" + _directorySeparator + ".." + _directorySeparator + ".." + _directorySeparator + "temp" + _directorySeparator + "."));
		}
