...
namespace WeSay.LexicalModel.Tests
{
 ...
 _repository.GetLexEntryWithMatchingGuid(guidToFind));
		...
		{
			LexEntry entry1 = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
			Assert.AreEqual(0,
		...
		{
			LexEntry entry1 = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
			MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
			Assert.AreEqual(1,
							_repository.GetHomographNumber(entry1, _headwordWritingSystem));
		}
		...
		{
			MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
			LexEntry entry2 = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
			Assert.AreEqual(2,
		...
		public void GetHomographNumber_AssignesUniqueNumbers()
		{
			...
			Assert.AreNotEqual("en", _headwordWritingSystem.IetfLanguageTag);
			LexEntry[] entries = new LexEntry[3];
			entries[0] = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
			entries[1] = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
			entries[2] = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
		...
		public void GetHomographNumber_ThirdEntry_Returns3()
		{
			...
			LexEntry entry1 = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
			LexEntry entry2 = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
			LexEntry entry3 = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
			Assert.AreEqual(3,
		...
		{
			LexEntry red1 = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "red");
			LexEntry blue1 = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
			LexEntry red2 = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "red");
			LexEntry blue2 = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
			LexEntry red3 = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "red");
			LexEntry blue3 = MakeEntryWithLexemeForm(_headwordWritingSystem.IetfLanguageTag, "blue");
		...
		public void GetAllEntriesSortedByHeadword_3EntriesWithLexemeForms_TokensAreSorted()
		{
			...
			e1.LexicalForm.SetAlternative(_headwordWritingSystem.IetfLanguageTag, "bank");
			_repository.SaveItem(e1);
			RepositoryId bankId = _repository.GetId(e1);

			LexEntry e2 = _repository.CreateItem();
			e2.LexicalForm.SetAlternative(_headwordWritingSystem.IetfLanguageTag, "apple");
			_repository.SaveItem(e2);
			RepositoryId appleId = _repository.GetId(e2);

			LexEntry e3 = _repository.CreateItem();
			e3.LexicalForm.SetAlternative(_headwordWritingSystem.IetfLanguageTag, "xa");
