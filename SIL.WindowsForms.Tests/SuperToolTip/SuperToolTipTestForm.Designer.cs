using SIL.WindowsForms.SuperToolTip;

namespace SIL.WindowsForms.Tests.SuperToolTip
{
	partial class SuperToolTipTestForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.superToolTip1 = new WindowsForms.SuperToolTip.SuperToolTip(this.components);
		...
		private WindowsForms.SuperToolTip.SuperToolTip superToolTip1;
