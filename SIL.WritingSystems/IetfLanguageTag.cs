...
namespace SIL.WritingSystems
{
	...
	public static class IetfLanguageTag
	{
		...
		/// If that doesn't work, return the English name.
		...
		/// For "zh" and "prs", which require special handling for the specific names we want,
		/// we only return the autonym or, if the UI language is English, the English name.
		/// </summary>
		[PublicAPI]
