...
namespace SIL.WritingSystems
{
	...
	{
		private static readonly Dictionary<string, string> _numberingSystemsDictionary = new Dictionary<string, string>();
		...
		public static List<string> StandardNumberingSystems => _numberingSystemsDictionary.Keys.ToList();
	}
}