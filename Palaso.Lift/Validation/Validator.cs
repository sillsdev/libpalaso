...
namespace Palaso.Lift.Validation
{
	...
	public class Validator
	{
		...
		/// (if any).
		///</summary>
		static public string GetAnyValidationErrors(string path, ValidationOptions validationOptions)
		{
			return GetAnyValidationErrors(path, null, validationOptions);
		}
		...
		///</summary>
		static public string GetAnyValidationErrors(XmlTextReader documentReader, ValidationOptions validationOptions)
		{
			string errors = "";
			if ((validationOptions & ValidationOptions.CheckLIFT) != null)
			{
				errors+=GetAnyValidationErrors(documentReader, null, validationOptions);
			}
		...
		{
			string errors = GetAnyValidationErrors(pathToLiftFile, progress, ValidationOptions.All);
