namespace Palaso.DictionaryService.SampleClient
{
	partial class SettingsControl
	{
		...
		{
			this._settingsGrid = new System.Windows.Forms.PropertyGrid();
			this.SuspendLayout();
			//
			// _settingsGrid
			//
			...
			this._settingsGrid.Size = new System.Drawing.Size(370, 218);
			this._settingsGrid.TabIndex = 0;
			this._settingsGrid.ToolbarVisible = false;
			//
			// Settings
			//
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this._settingsGrid);
		...
		private System.Windows.Forms.PropertyGrid _settingsGrid;
	}
}
