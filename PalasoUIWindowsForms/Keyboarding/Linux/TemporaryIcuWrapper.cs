...
{
	// TODO: Remove this class and replace with icudotnet(?) methods. Couldn't do that right now
	// because Palaso servers are not available.
	// This class is just a quick copy of IcuWrappers.cs from FW, with the methods that produced
