...
namespace SIL.Archiving.IMDI.Schema.NotUsed
{
	...
	//{
	//    private VocabularyType interactivityField;

	//    private VocabularyType planningTypeField;

	//    private VocabularyType involvementField;

	//    private VocabularyType socialContextField;

	//    private VocabularyType eventStructureField;

	//    private VocabularyType channelField;

	//    /// <remarks/>
	//    public VocabularyType Interactivity
	//    {
	//        get
	//        {
	...
	//    /// <remarks/>
	//    public VocabularyType PlanningType
	//    {
	//        get
	//        {
	...
	//    /// <remarks/>
	//    public VocabularyType Involvement
	//    {
	//        get
	//        {
	...
	//    /// <remarks/>
	//    public VocabularyType SocialContext
	//    {
	//        get
	//        {
	...
	//    /// <remarks/>
	//    public VocabularyType EventStructure
	//    {
	//        get
	//        {
