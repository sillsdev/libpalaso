...
namespace Palaso.WritingSystems
{
	...
	/// </summary>
	class LdmlNodeComparerV1 : IComparer<XmlNode>
	{
		public static LdmlNodeComparerV1 Singleton
		{
			get
			{
				if (_singleton == null)
				{
					_singleton = new LdmlNodeComparerV1();
				}
				return _singleton;
			}
		}

		private static LdmlNodeComparerV1 _singleton;
		private LdmlNodeComparerV1() { }
