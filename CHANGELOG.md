...
- [SIL.Windows.Forms] BREAKING CHANGE: Changed LocalizationIncompleteDlg.EmailAddressForLocalizationRequests to be a virtual property that returns null by default. If implementations do not override the property, the "More information" controls will be hidden.
