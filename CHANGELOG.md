...
- [SIL.Windows.Forms] BREAKING CHANGE: Added optional emailAddressForLocalizationRequests to LocalizationIncompleteDlg. If not supplied, the "More information" controls will be hidden.
