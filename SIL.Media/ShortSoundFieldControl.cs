...
namespace SIL.Media
{
	public partial class ShortSoundFieldControl : UserControl
	{
        ...
        public string PathToMediaRootDir { get; set; }
		...
		public ShortSoundFieldControl()
		{
            ...
            PathToMediaRootDir = String.Empty;
		}
        ...
        {
            if (!CopyFilesAlreadyInDefaultDir && !String.IsNullOrEmpty(PathToMediaRootDir) && dlgPath.StartsWith(PathToMediaRootDir))
                Path = dlgPath;
            // the file is outside the root media directory, make a copy
            else
