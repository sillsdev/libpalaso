...
#     VCS: https://bitbucket.org/sillsdev/l10nsharp []
# [2] build: icucil-precise64-SILWritingSystems Continuous (bt478)
#     project: Libraries
#     URL: http://build.palaso.org/viewType.html?buildTypeId=bt478
#     clean: false
#     revision: latest.lastSuccessful
#     paths: {"icu.net.dll"=>"lib/DebugMono", "icu.net.dll.config"=>"lib/DebugMono"}
#     VCS: https://github.com/sillsdev/icu-dotnet [icu54]
# [3] build: icucil-precise64-SILWritingSystems Continuous (bt478)
#     project: Libraries
#     URL: http://build.palaso.org/viewType.html?buildTypeId=bt478
#     clean: false
#     revision: latest.lastSuccessful
...
copy_auto http://build.palaso.org/guestAuth/repository/download/bt478/latest.lastSuccessful/icu.net.dll ../lib/DebugMono/icu.net.dll
copy_auto http://build.palaso.org/guestAuth/repository/download/bt478/latest.lastSuccessful/icu.net.dll.config ../lib/DebugMono/icu.net.dll.config
copy_auto http://build.palaso.org/guestAuth/repository/download/bt478/latest.lastSuccessful/icu.net.dll ../lib/ReleaseMono/icu.net.dll
copy_auto http://build.palaso.org/guestAuth/repository/download/bt478/latest.lastSuccessful/icu.net.dll.config ../lib/ReleaseMono/icu.net.dll.config
