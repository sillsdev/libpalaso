...
namespace SIL.Tests.Acknowledgements
{
	...
	public class AcknowledgementAttributeTests
	{
		...
		[TestCase("Key4", "myName", "www.fakeUrl", "Bob", "", "some location",
			ExpectedResult = "<li><a href='www.fakeUrl'>myName</a>: Bob</li>")]
			...
			string copyright, string license, string location)
		{
			...
			return new AcknowledgementAttribute(key, name, url, license, copyright, location).Html;
		}

		[Test]
		public void CreateAnAcknowledgement_NoCopyright_OverriddenByFile()
		{
			var ack = new AcknowledgementAttribute("testKey", "testName", "", "", "", "./NDesk.DBus.dll");
		...
		{
			var ack = new AcknowledgementAttribute("testKey", "", "", "myCopyright", "", "./nunit.framework.dll");
