...
namespace SIL.Tests.Unicode
{
	...
	{
		// For completeness, this list should be kept in synch with the list used in the following test
		// and with the list and switch statement in CharacterUtils itself.
		...
		// For completeness, this list should be kept in synch with the list used in the above test
		// and with the list and switch statement in CharacterUtils itself.
		[TestCase('.')] // ROMAN FULL STOP
		[TestCase('?')] // ROMAN QUESTION MARK
		[TestCase('!')] // ROMAN EXCLAMATION MARK
		...
		[TestCase('\uFF1F')] // FULLWIDTH QUESTION MARK
		[TestCase('\uFF61')] // HALFWIDTH IDEOGRAPHIC FULL STOP
		public void IsSentenceFinalPunctuation_CharacterIsSentenceFinalPunctuation_ReturnsTrue(char c)
		{
