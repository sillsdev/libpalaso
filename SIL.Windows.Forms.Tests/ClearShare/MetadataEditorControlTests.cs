...
namespace SIL.Windows.Forms.Tests.ClearShare
{
	...
	public class MetadataEditorControlTests
	{
		...
		public void ShowControl()
		{
			...
			m.License = new CreativeCommonsLicense(true, false, CreativeCommonsLicenseInfo.DerivativeRules.DerivativesWithShareAndShareAlike);
		...
		public void MetadataSetter_WasIGO_UncheckingProducesCurrentDefaultLicense()
		{
			...
			m.Creator = "test2";
			var ccLicense = new CreativeCommonsLicense(true, false, CreativeCommonsLicenseInfo.DerivativeRules.DerivativesWithShareAndShareAlike);
			...
			m.License = ccLicense;
			Assert.That(m.License.Url, Does.EndWith(CreativeCommonsLicenseInfo.kDefaultVersion+"/"));
		}
