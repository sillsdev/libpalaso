namespace PalasoUIWindowsForms.Tests.SettingsProtection
{
	partial class DialogWithSomeSettings
	{
		...
		{
			this._settingsProtectionLauncherButton = new Palaso.UI.WindowsForms.SettingProtection.SettingsProtectionLauncherButton();
		...
		private Palaso.UI.WindowsForms.SettingProtection.SettingsProtectionLauncherButton _settingsProtectionLauncherButton;
