...
namespace SIL.Core.ClearShare
{
	public class CreativeCommonsLicenseWithoutImage : LicenseInfo
	{
		...
		protected string GetComponentOfLicenseInBestLanguage(string idSuffix, string englishText, IEnumerable<string> languagePriorityIds, out string idOfLanguageUsed)
		{
