	...
	internal class UsbDriveInfoUDisks2 : UsbDriveInfo
	{
		...
		private static IEnumerable<string> GetUsbBlockDevices()
		{
			...
			var blockDevices =	managedObjects
				...
				.Where(obj => obj.Value != null && obj.Value.ContainsKey("org.freedesktop.UDisks2.Filesystem"))
				...
				.Where(obj =>
					{
						if (!obj.Value["org.freedesktop.UDisks2.Block"].ContainsKey("Drive"))
							return false;
						var drive = (ObjectPath)obj.Value["org.freedesktop.UDisks2.Block"]["Drive"];
						if (drive == null || !managedObjects.ContainsKey(drive) ||
							!managedObjects[drive].ContainsKey("org.freedesktop.UDisks2.Drive") ||
							!managedObjects[drive]["org.freedesktop.UDisks2.Drive"].ContainsKey("Removable") ||
							!managedObjects[drive]["org.freedesktop.UDisks2.Drive"].ContainsKey("ConnectionBus"))
							return false;
						var connectionBus =
							managedObjects[drive]["org.freedesktop.UDisks2.Drive"]["ConnectionBus"] as string;
						return (bool)managedObjects[drive]["org.freedesktop.UDisks2.Drive"]["Removable"] &&
							connectionBus.ToLowerInvariant() == "usb";
					});
