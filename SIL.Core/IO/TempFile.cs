...
namespace SIL.IO
{
	...
	public class TempFile : IDisposable
	{
		...
		/// </summary>
		/// <remarks>If you don't set a NamePrefix, this uses the GetTempFileName() method
		...
		/// <summary>
		/// Make a TempFile with the specified content. See also comment on NamePrefix.
		/// </summary>
		...
		/// <summary>
		/// Make a TempFile with the specified content and Encoding. See also comment on NamePrefix.
		/// </summary>
		...
		/// Setting a NamePrefix has several benefits:
		...
		/// <summary>
		/// If NamePrefix is set, remove all temp files (and directories, if any) created with that NamePrefix active.
		/// </summary>
		...
		/// <summary>
		/// Make a TempFile that is a copy of the specified one. See also comment on NamePrefix.
		/// </summary>
		...
		/// <summary>
		/// Use this one when it's important to have a certain file extension. See comment on NamePrefix.
		/// </summary>
