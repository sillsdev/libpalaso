...
namespace SIL.Reporting
{
	...
	public interface IErrorReporter
	{
		...
		/// </summary>
		/// <remarks>In contrast to the {resultIfAlternateButtonPressed} version, this method overload
		/// does not require the implementation to block (if the caller is not on the UI thread)
		...
		/// <summary>
		/// Notify the user of the {message}, if {policy} permits. Customize the {alternate button} label. Wait for user input. Return button clicked to the user.
		/// </summary>
