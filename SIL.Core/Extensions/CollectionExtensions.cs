	...
	public static class CollectionExtensions
	{
		...
		public static bool ContainsSequence<T>(this IList<T> list1, IList<T> list2)
		{
			for (int i1 = 0; i1 <= list1.Count - list2.Count; i1++)
			{
				...
				{
					// See http://stackoverflow.com/questions/390900/cant-operator-be-applied-to-generic-types-in-c/390974#390974
					if (!EqualityComparer<T>.Default.Equals(list1[i1 + i2], list2[i2]))
					{
