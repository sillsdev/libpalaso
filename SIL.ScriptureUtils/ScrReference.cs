...
#endregion
// 
// This class originated in FieldWorks (under the GNU Lesser General Public License) and was
// later copied to the LiSaFT project in Paratext, but we have decided to make it avaialble in
// SIL.ScriptureUtils as part of Palaso so it will be more readily available to other projects.
// ---------------------------------------------------------------------------------------------
using System;
