...
namespace SIL.WritingSystems.Tests
{
				...
				return new List<ValuesToSet>
							 {
								 ...
								 new ValuesToSet(CLDRNumberingSystems.Default, NumberingSystemDefinition.CreateCustomSystem("9876543210"))
							 };
			}
		}
	...
	public class WritingSystemDefinitionPropertyTests
	{
		...
		public void ModifyingDefinitionSetIsChangedFlag()
		{
			...
			firstValueToSet.Add(typeof(NumberingSystemDefinition), CLDRNumberingSystems.Default);
