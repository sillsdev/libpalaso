...
namespace SIL.DblBundle.Text
{
		...
		where TL : DblMetadataLanguage, new()
	{
		...
		private Stylesheet LoadStylesheet()
		{
			...
			if (exception != null)
			{
				throw new ApplicationException(Bundle.GetLocalizedMessage("DblBundle.StylesheetInvalid",
		...
		private void ExtractBooks()
		{
			...
			if (!m_books.Any())
			{
				throw new ApplicationException(Bundle.GetLocalizedMessage("DblBundle.UnableToLoadAnyBooks",
