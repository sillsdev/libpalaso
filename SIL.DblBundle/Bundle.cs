...
namespace SIL.DblBundle
{
	...
	{
		public static Func<string, string, string> GetLocalizedMessage = (id, englishString) => englishString;
	}
		...
		where TL : DblMetadataLanguage, new()
	{
		...
		protected Bundle(string pathToZippedBundle)
		{
			...
			{
				throw new ApplicationException(Bundle.GetLocalizedMessage("DblBundle.UnableToExtractBundle",
		...
		private TM LoadMetadata()
		{
			...
			if (!File.Exists(metadataPath))
			{
				...
				if (sourceBundle)
				{
					throw new ApplicationException(
						string.Format(Bundle.GetLocalizedMessage("DblBundle.SourceReleaseBundle",
				...
				throw new ApplicationException(
					string.Format(Bundle.GetLocalizedMessage("DblBundle.FileMissingFromBundle",
			...
			if (exception != null)
			{
				...
				{
					throw new ApplicationException(Bundle.GetLocalizedMessage("DblBundle.MetadataInvalid",
				...
				throw new ApplicationException(
					String.Format(Bundle.GetLocalizedMessage("DblBundle.MetadataInvalidVersion",
			...
			{
				throw new ApplicationException(
					String.Format(Bundle.GetLocalizedMessage("DblBundle.NotTextReleaseBundle",
